...
1. Download the workshop code zip file:
   ...
   {{% notice info %}}
   If you plan to use Python, C#, TypeScript or Node.js, download the All Languages version and refer to the [Additional Languages]({{< ref "/2_Setup_Configuration/_24_AdditionalLanguages" >}}) guide.
   {{% /notice %}}
