...
![Add data source 1](/images/exercise3/13-config1.png)
![Add data source 2](/images/exercise3/13-config2.png)

### Step 2: Load the Mapped Records

**Ask Amazon Q:** `Yes` to the prior question, or `load the mapped customer records into Senzing`

![Load Senzing 1](/images/exercise3/14-load1.png)
![Load Senzing 2](/images/exercise3/14-load2.png)
