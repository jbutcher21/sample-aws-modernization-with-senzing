...
|------|--------|-------------|
| 1 | [Configure IDE]({{< ref "/2_Setup_Configuration/22_Own_AWS_Account/221_ConfigureIDE.md" >}}) | Setup Visual Studio Code with all needed plugins, dependencies, and download the workshop code. |
| 2 | [Setup Amazon Q Developer]({{< ref "/2_Setup_Configuration/23_AmazonQSetup.md" >}}) | Set up authentication for Amazon Q Developer in your IDE and the CLI using either your organization's IDC Professional license or using an AWS Builder ID. |
