...
|------|--------|-------------|
| 1 | [Configure IDE]({{< ref "/2_Setup_Configuration/22_Own_AWS_Account/221_ConfigureIDE" >}}) | Setup Visual Studio Code with all needed plugins, dependencies, and download the workshop code. |
