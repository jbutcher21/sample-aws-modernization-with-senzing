...
{{% notice tip %}}
**What's Next?** Try mapping your own data! Start with the Workflow Summary (Step 1) as a guide, use the 5-stage mapping assistant, and apply the validation and analysis techniques you've learned. Good luck!
{{% /notice %}}
