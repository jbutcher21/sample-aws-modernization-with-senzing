...
{{% notice tip %}}
**Verify**: The AI should explicitly list all 5 files it loaded. If it skips any or says a file is unavailable, stop and troubleshoot before proceeding.
{{% /notice %}}
...
{{% notice info %}}
**Compare to Exercise 1**: In the customer mapping exercise, this stage was shown with detailed screenshots of each file being loaded. Here, we summarize the result. The underlying process is identical.
{{% /notice %}}
