...
{{% notice warning %}}
**Teaching Moment**: The AI initially said "3 master entity types" but only listed 2 (Person and Company). This is exactly the kind of error you should catch and correct!
{{% /notice %}}
...
{{% notice info %}}
**Why separate DATA_SOURCE codes?** This allows Senzing to track which system contributed which information. When a Person from SANCTIONS matches a director in CORP_FILINGS, you can see both sources in the resolved entity.
{{% /notice %}}
